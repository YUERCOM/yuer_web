$(function(){ 
	...
	$(".yuer_cancel").click(function(){
		$(this).parent().parent().yuerMsg("hide");
	});
...
;(function($) {
	...
	var content_html = function(type,msg){
		...
		$("#_yuer_dialog_msg_div").after(yuer_full_screen_div);
		...
		yuer_dialog_msg_bottom_div.id = "_yuer_dialog_msg_bottom_div";
	 	if(type == "error"){
			...
			//yuer_dialog_msg_div.append(yuer_dialog_msg_top_div);  IE不支持
			$("#_yuer_dialog_msg_div").append(yuer_dialog_msg_top_div);
			if(msg.length <= 15){
			...
			//yuer_dialog_msg_div.append(yuer_dialog_msg_content_div);  IE不支持
			$("#_yuer_dialog_msg_div").append(yuer_dialog_msg_content_div);
			...
			yuer_dialog_msg_bottom_div_a.id = "_yuer_dialog_msg_bottom_div_a";
			...
			// yuer_dialog_msg_bottom_div.append(yuer_dialog_msg_bottom_div_a);  IE不支持
			// yuer_dialog_msg_div.append(yuer_dialog_msg_bottom_div);  IE不支持
			$("#_yuer_dialog_msg_div").append(yuer_dialog_msg_bottom_div);
			$("#_yuer_dialog_msg_bottom_div").append(yuer_dialog_msg_bottom_div_a);
			...
			$("#_yuer_dialog_msg_div").append(yuer_dialog_msg_content_div);
	 		if(type == "info"){
				...
				$("#_yuer_dialog_msg_bottom_div").append(yuer_dialog_msg_bottom_div_a);
	 			...
	 			yuer_dialog_msg_top_div.innerText = "确认信息";
				...
				// yuer_dialog_msg_bottom_div_sure.append(yuer_dialog_msg_bottom_div_sure_a);  IE不支持
				// yuer_dialog_msg_bottom_div.append(yuer_dialog_msg_bottom_div_sure);  IE不支持
				...
				// yuer_dialog_msg_bottom_div_cancel.append(yuer_dialog_msg_bottom_div_cancel_a);  IE不支持
				// yuer_dialog_msg_bottom_div.append(yuer_dialog_msg_bottom_div_cancel);  IE不支持
				// yuer_dialog_msg_div.append(yuer_dialog_msg_bottom_div);  IE不支持

				$("#_yuer_dialog_msg_div").append(yuer_dialog_msg_bottom_div);
				$("#_yuer_dialog_msg_bottom_div").append(yuer_dialog_msg_bottom_div_sure);
				$("#_yuer_dialog_msg_bottom_div").append(yuer_dialog_msg_bottom_div_cancel);
				$("#_yuer_dialog_msg_bottom_div_sure").append(yuer_dialog_msg_bottom_div_sure_a);
				$("#_yuer_dialog_msg_bottom_div_cancel").append(yuer_dialog_msg_bottom_div_cancel_a);
	 		}
	 	}
		
		//yuer_dialog_msg_div.after(yuer_full_screen_div);  IE不支持
	}
